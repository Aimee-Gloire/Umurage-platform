...
const mockNotifications = [
  {
    ...
    message: 'Mugisha Jean submitted the Kinyarwanda grammar assignment',
    time: '30 minutes ago',
    read: false,
    type: 'assignment'
  },
  {
    ...
    message: 'Update needed for Traditional Rwandan Art course module',
    time: '2 hours ago',
    read: false,
    type: 'course'
  },
  {
    ...
    message: 'New student question about Imigongo patterns in the forums',
    time: '1 day ago',
    read: true,
    type: 'discussion'
  },
  {
    ...
    message: 'You are scheduled to coordinate the Umuganura festival workshop next week',
    time: '2 days ago',
    read: true,
    type: 'event'
  }
