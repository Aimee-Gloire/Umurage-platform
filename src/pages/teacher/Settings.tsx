...
import { 
  Bell, Lock, Eye, Globe, Moon, Sun, 
  Volume2, Mail, BookOpen, Users, Clock,
  Shield, Sliders
} from 'lucide-react';
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="space-y-6">
        ...
        <motion.section
          ...
          className="bg-white rounded-2xl shadow-lg p-6"
        >
          <h2 className="text-xl font-semibold mb-4">Teaching Preferences</h2>
          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
              <div className="flex items-center space-x-3">
                <BookOpen className="h-5 w-5 text-gray-700" />
                <div>
                  <p className="font-medium">Course Display</p>
                  <p className="text-sm text-gray-500">Customize how your courses appear</p>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="font-medium">Student Interactions</p>
                  <p className="text-sm text-gray-500">Manage student communication settings</p>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Set your availability schedule</p>
                </div>
              </div>
